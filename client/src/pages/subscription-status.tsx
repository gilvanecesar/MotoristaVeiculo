...
import { CreditCard, Calendar, DollarSign, CheckCircle, Clock, ArrowRight } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          {isActive ? (
            ...
            <div className="text-center py-8 space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-semibold">Assinatura Inativa</h3>
                <p className="text-muted-foreground max-w-md mx-auto">
                  Você não possui uma assinatura ativa. Assine agora para ter acesso completo ao sistema.
                </p>
              </div>
              <Button 
                onClick={() => navigate('/checkout?plan=monthly')}
